...
if ( ! class_exists( 'Note_Widget' ) ) {
	final class Note_Widget extends WP_Widget {
		...
		function __construct() {
			...
			if ( ! has_action( 'note_widget', array( self::class, 'note_widget' ) ) )
				add_action( 'note_widget', array( self::class, 'note_widget' ), 10, 3 ); // Output standard Note Widget content
			if ( ! has_action( 'note_widget_after', array( self::class, 'note_widget_after' ) ) )
				add_action( 'note_widget_after', array( self::class, 'note_widget_after' ), 10, 3 ); // Output standard Note Widget content
